          ...
          <div className="flex-1 overflow-y-auto p-6 space-y-6">
            ...
            <div className="text-center">
              <Avatar className="h-24 w-24 mx-auto mb-4 ring-4 ring-[#F5F3EF]">
                ...
                <AvatarFallback className="bg-gradient-to-br from-[#C77F49] to-[#8B6F5A] text-white text-2xl font-semibold">
                  CS
                </AvatarFallback>
              </Avatar>
              <h3 className="text-xl font-semibold text-[#2B2420] tracking-tight">
                {user.name}
              </h3>
              <p className="text-sm text-[#6B6359] mt-1">{user.role}</p>
              <p className="text-xs text-[#8B6F5A] mt-0.5">{user.crp}</p>
              
              <Badge className="mt-3 bg-[#E8F0E9] text-[#6F7C6D] hover:bg-[#E8F0E9] font-medium">
                Plano {user.plan}
              </Badge>
            </div>
            ...
            <div className="space-y-3">
              <div className="p-4 bg-[#F5F3EF] rounded-xl">
                ...
                <p className="text-sm text-[#2B2420] font-medium">{user.email}</p>
              </div>
              ...
              <div className="p-4 bg-[#F5F3EF] rounded-xl">
                ...
                <div className="flex items-center justify-between">
                  <p className="text-sm text-[#2B2420] font-medium">Plano Pro</p>
                  <span className="text-xs text-[#6F7C6D] font-semibold">Ativo</span>
                </div>
              </div>
            </div>
            ...
            <div className="space-y-2">
              <button className="w-full flex items-center gap-3 px-4 py-3 rounded-xl text-[#2B2420] hover:bg-[#F5F3EF] transition-all duration-200 text-sm font-medium group">
                <User className="h-5 w-5 text-[#8B6F5A] group-hover:text-[#C77F49] transition-colors" />
                Editar Perfil
              </button>
              
              <button className="w-full flex items-center gap-3 px-4 py-3 rounded-xl text-[#2B2420] hover:bg-[#F5F3EF] transition-all duration-200 text-sm font-medium group">
                <Shield className="h-5 w-5 text-[#8B6F5A] group-hover:text-[#C77F49] transition-colors" />
                Privacidade e Segurança
              </button>
              
              <button className="w-full flex items-center gap-3 px-4 py-3 rounded-xl text-[#2B2420] hover:bg-[#F5F3EF] transition-all duration-200 text-sm font-medium group">
                <CreditCard className="h-5 w-5 text-[#8B6F5A] group-hover:text-[#C77F49] transition-colors" />
                Faturamento
              </button>
            </div>
          </div>
